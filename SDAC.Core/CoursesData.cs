...
namespace SDAC.Core
{
    public class CoreCoursesData
    {
        protected CoursesData _courses = new CoursesData();
       ...
       /// <returns></returns>
        ...
        #region CUD Methods
        /// <summary>
        /// Creates _courses transcripts details
        /// </summary>
        /// <param name="accToken"></param>
        /// <param name="data"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Updates _courses transcripts details
        /// </summary>
        /// <param name="accToken"></param>
        /// <param name="data"></param>
        /// <param name="courseId"></param>
        ...
        /// <summary>
        /// Deletes _courses transcripts details
        /// </summary>
        /// <param name="accToken"></param>
        /// <param name="courseId"></param>
        /// <returns></returns>
