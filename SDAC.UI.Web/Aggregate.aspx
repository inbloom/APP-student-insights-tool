        ...
        function validation() {
            ...
            if (count >= 1 && count <= 5) {
                ...
                if (count > 5) {
                    ...
                    $("#flaglist").html("Please select one or more flags.");
                    $("#flaglist").show();
                    ClientMessage += "<p>Please select one or more flags.</p><br />";
                }
...
<div class="box">
    <h3>Enter information about the flag you would like to create.</h3>
        ...
        <div class="flag_imformation">
             ...
             <p>Name<span>*</span></p>
              <asp:TextBox ID="txtFlagName" ClientIDMode="Static" 
                                class="txtbox" CssClass="textfield" runat="server" Rows="5" Width="447px" MaxLength="100" 
                                onkeyup="getLength(this,100,flag_name_count);" onKeyDown="getLength(this,100,flag_name_count);" onfocus="blank(this)" onblur="unblank(this)"  >Enter a name for the flag </asp:TextBox>
              <p id="flag_name_count" class="warning delta"> 100 Characters
remaining</p>
              <p id="P1" class="delta"> <asp:RequiredFieldValidator
ID="RequiredFieldValidatorFlagName" runat="server"
                                 ErrorMessage="Required Field"
ForeColor="#FF0066"

 ControlToValidate="txtFlagName"></asp:RequiredFieldValidator> </p>

              <div class="c_both">&nbsp;</div>
               <p>Description<span>*</span></p>
                <asp:TextBox ID="txtDescription" runat="server"
 CssClass="textarea" class="txtbox_area" ClientIDMode="Static"
TextMode="MultiLine"  onKeyDown="getLength(this,500,charCount);" 
 onKeyUp="getLength(this,500,charCount);"
Rows="4" onfocus="blank(this)" onblur="unblank(this)">Enter a detailed description about the Flag. The first two lines
of the text will be displayed as a short description. You can also expand
the view to display the full description</asp:TextBox>
                <p id="charCount" class="warning delta">500 Characters
remaining</p>
                <p id="P2" class="delta"><asp:RequiredFieldValidator
ID="RequiredFieldValidatorDescription" runat="server"
                                 ErrorMessage="Required Field"
ForeColor="#FF0066"

 ControlToValidate="txtDescription"></asp:RequiredFieldValidator></p>

                <div class="c_both">&nbsp;</div>
              <p>Keyword</p>
              <asp:TextBox ID="txtFlag" class="txtbox" runat="server"
onkeyup="getLength(this,100,flag_keyword_count);" onKeyDown="getLength(this,100,flag_keyword_count);"  Width="447px"
MaxLength="100" onfocus="blank(this)" onblur="unblank(this)" ClientIDMode="Static"
CssClass="textfield" >Enter one or more keywords for the flag (optional)</asp:TextBox>

                <p id="flag_keyword_count" class="warning delta">100
Characters remaining</p>
             ...
             <p class="f_left sigma">Type</p>
                  <asp:RadioButtonList ID="radioFlagType" CssClass="f_left
tblsss" runat="server" RepeatDirection="Horizontal">
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server" >
    ...
    <div class="search_penal">
            <div class="search_bg"><input id="autocomplete" title="type autocomplete='off'
&quot;a&quot;"></div>

            <p class="mar_right" style="float:left;"><asp:CheckBox 
ID="CheckBoxShowTag" runat="server" Text="Show Public Flags" Checked="true" 
                    oncheckedchanged="CheckBoxShowTag_CheckedChanged" AutoPostBack="true" /></p>
...
<tbody><tr align="left" style="color:White;background-color:Black;height:20px;">
     <th scope="col" class="aggr_id" ></th>
     <th scope="col" class="aggr_flagname">Flag Name</th>
     <th scope="col" class="aggr_descr">Description</th>
     <th scope="col" class="aggr_key">Keyword</th>
    </tr>
    </tbody></table>
...
<div class="table_style" style="height: 220px;  margin: -1px 0 0;overflow:scroll;border:1px solid #ccc; ">
                        ...
                        <ItemTemplate>
                            <asp:CheckBox
                        ID="chkBoxSelect" runat="server" ClientIDMode="Static" onclick="checkTest(this);" />
                            <%-- <asp:LinkButton
                        ID="lnkBtnSelect" runat="server"
                        CommandArgument='<%#((GridViewRow)Container).RowIndex%>'
                        CommandName="SelectRow" CausesValidation="False">Select</asp:LinkButton>
                        --%>
                        </ItemTemplate>
                        <HeaderStyle
                        CssClass="bod_none" />
                        ...
                        DataField="FlagName" SortExpression="FlagName"  >
                        <HeaderStyle CssClass="bod_none abc"  />
                        <ItemStyle CssClass="bod_none" Width="108px" />
                        </asp:BoundField>
                        <asp:BoundField
                        HeaderText="Description" DataField="FlagDescription"
                        SortExpression="FlagDescription" >
                        <HeaderStyle CssClass="bod_none"  />
                        <ItemStyle CssClass="bod_none" Width="329px"  />
                        </asp:BoundField>
                        <asp:BoundField HeaderText="Keyword"
                        DataField="Keyword"
                        SortExpression="Keyword" >
                        <HeaderStyle CssClass="bod_none abc" BorderColor="#AAAAAA" BorderStyle="Solid" 
                                BorderWidth="1px" />
                        <ItemStyle CssClass="bod_none" Width="87px"  />
                        </asp:BoundField>
...
<p> <asp:Button ID="btnForward" runat="server" Text="" CssClass="nextbutton" ClientIDMode="Static"
 onclick="btnForward_Click" OnClientClick="javascript:return checkMax();"/> </p>
<p><asp:Button ID="btnBackword" CssClass="back"  runat="server" Text=""
onclick="btnBackword_Click" OnClientClick="javascript:return chklistempty();"  /></p>
</div>


        <div class="right_penal">
        <div id="flaglist"></div>
<asp:ListBox ID="lstcategory" runat="server" Height="225px" Width="225px" CssClass="listbox_style"
ClientIDMode="Static" SelectionMode="Multiple" style="font-size:12px"> </asp:ListBox>
            <asp:HiddenField ID="HiddenFieldFlagCount" runat="server" ClientIDMode="Static" />
 <div class="buttons">
                <asp:Button ID="btnSave" ClientIDMode="Static"
runat="server" Text="Save" CssClass="btn_small" onclick="btnSave_Click"
 ...
 <Triggers>            
            ...
            <asp:AsyncPostBackTrigger ControlID="CheckBoxShowTag" EventName="CheckedChanged"></asp:AsyncPostBackTrigger>           
              ...
              <div id="hidden_clicker" style="display:none;">
                    <a class="overlay" id="hiddenclicker" href="#"
title="Please correct the above errors and re-submit.">Inline</a>
              </div>
  ...
  <%--   <script src="JS/ScrollableGridPlugin.js" type="text/javascript"></script>--%>
               ...
               /*       $(document).ready(function () {
                   ...
                   // alert("am, here");
                    $('#<%=gridStudentInfo.ClientID %>').Scrollable({
                    ScrollHeight: 220,        
                    });
                    });*/
