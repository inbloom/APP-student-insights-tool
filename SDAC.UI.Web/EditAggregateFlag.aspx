<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditAggregateFlag.aspx.cs" Title="SDAC >> Edit Aggregate Flag" Inherits="SDAC.UI.Web.EditAggregateFlag" MasterPageFile="~/StudentAggregate.Master" %>
...
<tbody><tr align="left" style="color:White;background-color:Black;height:20px;">
     ...
     <th scope="col" class="copy_aggr_key" >Keyword</th>
            ...
            <div class="table_style" style="height: 220px; overflow: scroll;border:1px solid #ccc;  ">
                <asp:Panel ID="Panel1" runat="server">
                            <asp:GridView ID="gridStudentInfo" runat="server" AutoGenerateColumns="False" ClientIDMode="Static" class="tblhead" CellPadding="0" GridLines="Vertical" style="border-bottom:1px solid #AAAAAA" ShowHeader="False"  >
                                 ...
                                 <Columns>
                                            ...
                                            <asp:BoundField HeaderText="Keyword" DataField="Keyword" SortExpression="Keyword" >
                                                <HeaderStyle CssClass="bod_none abc" Width="121px" BorderColor="#AAAAAA" 
