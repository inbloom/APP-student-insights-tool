    ...
    <h3>Enter information about the flag you would like to create.</h3>
        ...
        <div class="flag_imformation">
             ...
             <asp:TextBox ID="txtFlagName" ClientIDMode="Static" 
                                ...
                                onkeyup="getLength(this,100,flag_name_count);" onKeyDown="getLength(this,100,flag_name_count);"  onblur="unblank(this)"  >Enter a name for the flag </asp:TextBox>
...
TextMode="MultiLine" onKeyDown="getLength(this,500,charCount);" 
 onKeyUp="getLength(this,500,charCount);"  onblur="unblank(this)"
Rows="4">Enter a detailed description about the Flag. The first two lines
...
Characters remaining</p>
    ...
    <div class="box">
    <h3>Follow the steps below to setup the criteria for how the flag
       should function. </h3>
    </div>
...
<div class="first_penal">
             ...
             <div class="search_bg2"><asp:TextBox ID="autoComplete"
autoComplete='off' onkeydown = "return (event.keyCode!=13);" runat="server"
ClientIDMode="Static" EnableViewState="True"></asp:TextBox>
...
<div class="second_penal">
                    ...
                    <asp:ListBox ID="lstCondition" runat="server"
                        DataTextField="ConditionName"
DataValueField="ConditionId" ClientIDMode="Static"
                        ViewStateMode="Enabled"  Rows="18">
                    </asp:ListBox>
  </div>
 ...
 <!-- third_penal Class End  -->
        ...
        <!-- forth_penal Class Start  -->
            ...
            <h4>Display students where:</h4>
                <h4><asp:Label ID="entity" runat="server" Text=""
ClientIDMode="Static" style="display:none;" CssClass="ggspan"></asp:Label>
<asp:Label ID="condition" runat="server" Text="" ClientIDMode="Static"
style="display:none;" CssClass="ggspan"></asp:Label> <asp:Label ID="val1"
runat="server" Text="" ClientIDMode="Static" style="display:none;"
CssClass="ggspan"></asp:Label><asp:Label ID="val2" runat="server" Text="& "
style="display:none;" ClientIDMode="Static" CssClass="ggspan"></asp:Label>
                </h4>
            ...
            <ContentTemplate>
                     <asp:GridView ID="gridDisplayResult" runat="server" AutoGenerateColumns="False" class="tblhead" CellPadding="3" GridLines="Vertical" Width="100%">
                                <Columns>
...
<!-- Box2 Class End -->
    ...
    <!-- Add / Edit Penal Ends -->
     <asp:HiddenField ID="hdndttype" runat="server"
ClientIDMode ="Static" />
         <div id="hidden_clicker" style="display:none;">
    <a class="overlay" id="hiddenclicker" href="#" title="Please correct
the above errors and re-submit.">Inline</a>
    </div>
